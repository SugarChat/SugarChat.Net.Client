...
namespace SugarChat.Net.Client
{
    public interface ISugarChatClient
    {
        ...
        Task<SugarChatResponse<PagedResult<ConversationDto>>> GetUnreadConversationListAsync(GetUnreadConversationListRequest request, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> BatchCreateGroupAsync(BatchAddGroupCommand command, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> BatchSetGroupMemberCustomFieldAsync(BatchSetGroupMemberCustomFieldCommand command, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> BatchAddGroupMemberAsync(BatchAddGroupMemberCommand command, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> BatchSendMessageAsync(BatchSendMessageCommand command, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> RemoveUserAsync(RemoveUserCommand command, CancellationToken cancellationToken = default);

        Task<SugarChatResponse> RemoveAllUserAsync(RemoveAllUserCommand command, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse<PagedResult<MessageDto>>> GetMessagesByGroupIdsAsync(GetMessagesByGroupIdsRequest request, CancellationToken cancellationToken = default);
        ...
        Task<SugarChatResponse> BatchSetMessageReadByUserIdsBasedOnGroupIdAsync(BatchSetMessageReadByUserIdsBasedOnGroupIdCommand command, CancellationToken cancellationToken = default);

        Task<SugarChatResponse> SetMessageUnreadByUserIdsBasedOnGroupIdAsync(SetMessageUnreadByUserIdsBasedOnGroupIdCommand command, CancellationToken cancellationToken = default);
